...
Item {
    ...
    function updateKeyBindingTooltip() {
        ...
        if (root.maskMode === K.MaskModeType.MaskPreview) {
            ...
            root.controller.setWidgetKeyBinding(KI18n.xi18nc("@info:whatsthis","<shortcut>Click</shortcut> to add a point, <shortcut>Alt+click</shortcut> to exclude, <shortcut>Ctrl+drag</shortcut> to draw a box, <shortcut>Shift+click</shortcut> to extend."));
        }
    }
    ...
    Label {
        ...
        padding: 5
        text: root.maskMode === K.MaskModeType.MaskPreview ? KI18n.i18n("Previewing video mask") : root.brushMode ? KI18n.i18n("Paint a brush stroke to select an object.\nAlt+drag to exclude a zone.\nShift+click to add a point, Ctrl+drag for a box.") : KI18n.i18n("Click to add a point, Alt+click to exclude.\nCtrl+drag to draw a box.\nShift+click to extend selection.")
